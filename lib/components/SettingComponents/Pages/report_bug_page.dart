...
class _ReportBugPageState extends State<ReportBugPage>
  ...
  Future<void> _getDeviceAndAppInfo() async {
    try {
      ...
      _appVersion = '${packageInfo.appName} ${packageInfo.version} (${packageInfo.buildNumber})';
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildTextField(
                        ...
                        maxLines: 5,
                        hint: 'Describe what happened and what you expected to happen',
                        validator: (value) {
                          if (value == null || value.isEmpty) {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          // Bug report form - you can use the form content from the previous code
        ],
      ),
    );
  }
